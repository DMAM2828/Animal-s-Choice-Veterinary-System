	...
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped">
				...
				<?php
$i = 1;
$qry = $conn->query("SELECT *, CONCAT(firstname, ' ', lastname) as name FROM `users` WHERE id != '1' AND type IN (1, 2, 3) ORDER BY CONCAT(firstname, ' ', lastname) ASC");
        ...
        <td align="center">
            ...
            <div class="dropdown-menu" role="menu">
                ...
                <?php if ($row['status'] != 1): ?>
                    ...
                    <div class="dropdown-divider"></div>
                <?php endif; ?>
                <a class="dropdown-item archive_user" href="javascript:void(0)" data-id="<?= $row['id'] ?>"  data-name="<?= $row['username'] ?>"><span class="fa fa-archive text-primary"></span> Archive</a>
            </div>
        </td>
    </tr>
<?php endwhile; ?>
